...
import { Compass, ShieldCheck, Sparkles, Target, TrendingUp, Wallet, Loader2 } from 'lucide-react';
...
export default function UserHorizon() {
  const { automationStats, rules, loading } = useApp();
  ...
  const chartData = useMemo(() => {
    ...
    const automationBoost = automationStats?.projectedMonthlyContribution || 0;
    const data = [];
    let currentOnly = 0;
    let programmable = 0;
    ...
    return data;
  }, [automationStats?.projectedMonthlyContribution, months, monthly, strategy, riskProfile]);
    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-20">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <div className="glass-card px-4 py-3">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Programmable boost</p>
          <p className="mt-2 text-xl font-black text-foreground">{formatCurrency(automationStats.projectedMonthlyContribution)}/mo</p>
        </div>
      </div>
        ...
        <div className="space-y-6 lg:col-span-8">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="glass-card p-5">
              ...
              <p className="mt-1 text-sm text-muted-foreground">With your rule engine contributing.</p>
            </div>
            ...
            <div className="glass-card p-5">
              ...
              <p className="mt-1 text-sm text-muted-foreground">Additional wealth created by engine.</p>
            </div>
          </div>
        </div>
      </div>
